...
import Profile from "../../assets/profile/Unknown-7.jpeg";
          ...
          <Row className="pt-3 pb-5 align-items-center">
            ...
            <Col xs={12} md={6}>
              <Row className=" align-items-start p-2 my-details rounded">
                Hi there! I am <strong>&nbsp;Anmol Sharma</strong>
                ...
                <br />
                I am pursuing my Engineering from UPES in Computer Science with
                ...
                <Col className="d-flex justify-content-center flex-wrap">
                  ...
                  <div>
                    <a
                      href="https://github.com/anmol1402"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  <div>
                    <a
                      href="https://www.linkedin.com/in/anmol-sharma-65a9051b4/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
